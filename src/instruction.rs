...
pub enum OpCode {
    ...
    CPL,                // toggle every bit of a reg
    BIT(Target, u32),   // test to see if a sepcific bit of a specific register is set
    RESET(Target, u32), // set specific bit of specific register to 0
    SET(Target, u32),   // set specific bit of specific register to 1
...
lazy_static! {
    static ref INSTRUCTIONS: HashMap<u8, Instruction> = {
        ...
        m.insert(0x0A as  u8, Instruction::new(OpCode::LDR(Target::A, Target::BC), 1, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x0E as  u8, Instruction::new(OpCode::LDR(Target::C, Target::D8), 2, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x12 as  u8, Instruction::new(OpCode::LDR(Target::DE, Target::A), 1, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x16 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::D8), 2, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x1A as  u8, Instruction::new(OpCode::LDR(Target::A, Target::DE), 1, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x1E as  u8, Instruction::new(OpCode::LDR(Target::E, Target::D8), 2, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x22 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::A), 1, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED])); // +
        m.insert(0x26 as  u8, Instruction::new(OpCode::LDR(Target::H, Target::D8), 2, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x2A as  u8, Instruction::new(OpCode::LDR(Target::A, Target::HL), 1, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED])); // +
        m.insert(0x2E as  u8, Instruction::new(OpCode::LDR(Target::G, Target::D8), 2, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x32 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::A), 1, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED])); // -
        m.insert(0x36 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::D8), 2, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x3A as  u8, Instruction::new(OpCode::LDR(Target::A, Target::HL), 1, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED])); // -
        m.insert(0x3E as  u8, Instruction::new(OpCode::LDR(Target::A, Target::D8), 2, 8, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x40 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x41 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x42 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x43 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x44 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x45 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x46 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x47 as  u8, Instruction::new(OpCode::LDR(Target::B, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x48 as  u8, Instruction::new(OpCode::LDR(Target::C, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x49 as  u8, Instruction::new(OpCode::LDR(Target::C, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x4A as  u8, Instruction::new(OpCode::LDR(Target::C, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x4B as  u8, Instruction::new(OpCode::LDR(Target::C, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x4C as  u8, Instruction::new(OpCode::LDR(Target::C, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x4D as  u8, Instruction::new(OpCode::LDR(Target::C, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x4E as  u8, Instruction::new(OpCode::LDR(Target::C, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x4F as  u8, Instruction::new(OpCode::LDR(Target::C, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x50 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x51 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x52 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x53 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x54 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x55 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x56 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x57 as  u8, Instruction::new(OpCode::LDR(Target::D, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x58 as  u8, Instruction::new(OpCode::LDR(Target::E, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x59 as  u8, Instruction::new(OpCode::LDR(Target::E, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x5A as  u8, Instruction::new(OpCode::LDR(Target::E, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x5B as  u8, Instruction::new(OpCode::LDR(Target::E, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x5C as  u8, Instruction::new(OpCode::LDR(Target::E, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x5D as  u8, Instruction::new(OpCode::LDR(Target::E, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x5E as  u8, Instruction::new(OpCode::LDR(Target::E, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x5F as  u8, Instruction::new(OpCode::LDR(Target::E, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x60 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x61 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x62 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x63 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x64 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x65 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x66 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x67 as  u8, Instruction::new(OpCode::LDR(Target::G, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x68 as  u8, Instruction::new(OpCode::LDR(Target::H, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x69 as  u8, Instruction::new(OpCode::LDR(Target::H, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x6A as  u8, Instruction::new(OpCode::LDR(Target::H, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x6B as  u8, Instruction::new(OpCode::LDR(Target::H, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x6C as  u8, Instruction::new(OpCode::LDR(Target::H, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x6D as  u8, Instruction::new(OpCode::LDR(Target::H, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x6E as  u8, Instruction::new(OpCode::LDR(Target::H, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x6F as  u8, Instruction::new(OpCode::LDR(Target::H, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x70 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x71 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x72 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x73 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x74 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x75 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x76 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x77 as  u8, Instruction::new(OpCode::LDR(Target::HL, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));

        m.insert(0x78 as  u8, Instruction::new(OpCode::LDR(Target::A, Target::B), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x79 as  u8, Instruction::new(OpCode::LDR(Target::A, Target::C), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x7A as  u8, Instruction::new(OpCode::LDR(Target::A, Target::D), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x7B as  u8, Instruction::new(OpCode::LDR(Target::A, Target::E), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x7C as  u8, Instruction::new(OpCode::LDR(Target::A, Target::G), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x7D as  u8, Instruction::new(OpCode::LDR(Target::A, Target::H), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x7E as  u8, Instruction::new(OpCode::LDR(Target::A, Target::HL), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
        m.insert(0x7F as  u8, Instruction::new(OpCode::LDR(Target::A, Target::A), 1, 4, 0, vec![NOT_AFFECTED, NOT_AFFECTED, NOT_AFFECTED ,NOT_AFFECTED]));
